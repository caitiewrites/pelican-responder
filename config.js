...
const postReplyWithMedia = (client, mediaFilePath, replyTweet) => {
    ...
    initMediaUpload(client, mediaFilePath)
        ...
        .then((mediaId) => {
            let statusObj = {
                status: "Hi @" + replyTweet.user.screen_name + ", here's your autogenerated surreal #pelicanstairs image! Read more about this art project at https://pelicanstairs.art/about . Come back soon (or were you here all along?)",
